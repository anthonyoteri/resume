...
%--------------------------------
	...
	\cvlistdoubleitem{Linux}														{Git, Subversion, CVS, and Perforce}
	\cvlistdoubleitem{Docker and LXC}												{MySQL / MariaDB, Microsoft SQL Server, Elasticsearch, Cassandra}
	\cvlistdoubleitem{KVM, VMware, OpenStack, VirtualBox, OpenNebula, and Vagrant}	{Jenkins, Github.}
